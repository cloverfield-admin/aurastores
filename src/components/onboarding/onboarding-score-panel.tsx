...
export function OnboardingScorePanel({ progressPercent = 25 }: OnboardingScorePanelProps) {
  ...
  return (
    <aside className="w-full max-w-[216px] shrink-0">
      <div className="sticky top-24 rounded-[32px] border border-[rgba(187,201,199,0.1)] bg-white/80 p-8 shadow-[0_20px_25px_-5px_rgba(19,78,74,0.05),0_8px_10px_-6px_rgba(19,78,74,0.05)] backdrop-blur-md">
        <div
        ...
        <h3 className="mt-6 font-[family-name:var(--font-manrope)] text-xl font-bold leading-7 text-[#191c1e]">
          Onboarding
          <br />
          Score
        </h3>
        <p className="mt-3 text-sm leading-relaxed text-[#3c4948]">
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="h-2 overflow-hidden rounded-full bg-[#e0e3e5]">
            <div
              className="h-full rounded-full bg-[#006a65] transition-[width]"
              style={{ width: `${pct}%` }}
            />
          </div>
        </div>
        <div className="mt-8 space-y-4 border-t border-[rgba(187,201,199,0.15)] pt-8">
          <div className="flex items-center gap-3">
            <span className="size-2 shrink-0 rounded-full bg-[#006a65]" />
